...
export const Icon = {
  ...
  phone: (p: IconProps) => (
    <IconBase
      {...p}
      d="M22 16.9v3a2 2 0 0 1-2.2 2 19.8 19.8 0 0 1-8.6-3.1 19.5 19.5 0 0 1-6-6 19.8 19.8 0 0 1-3.1-8.7A2 2 0 0 1 4.1 2h3a2 2 0 0 1 2 1.7c.1.9.3 1.8.6 2.6a2 2 0 0 1-.5 2.1L8 9.7a16 16 0 0 0 6 6l1.3-1.3a2 2 0 0 1 2.1-.5c.8.3 1.7.5 2.6.6A2 2 0 0 1 22 16.9z"
    />
  ),
  chat: (p: IconProps) => (
  ...
  more: (p: IconProps) => (
    <IconBase
      {...p}
      d={<><circle cx="12" cy="12" r="1" /><circle cx="5" cy="12" r="1" /><circle cx="19" cy="12" r="1" /></>}
    />
  ),
  ...
  micOff: (p: IconProps) => (
    <IconBase
      ...
      d={
        <>
          <path d="M1 1l22 22" />
          <path d="M9 9v4a3 3 0 0 0 5.1 2.1M15 9V5a3 3 0 0 0-6-.7" />
          <path d="M17 16.9A7 7 0 0 1 5 12M12 19v3" />
        </>
      }
    />
  ),
  phoneOff: (p: IconProps) => (
    <IconBase
      ...
      d={
        <>
          <path d="M10.7 13.3a16 16 0 0 1-3-4.7" />
          <path d="M2 2l20 20" />
          <path d="M8.5 2.5a19 19 0 0 1 13 13 2 2 0 0 1-1.2 2.3c-.6.2-1.2.4-1.8.4M5 17a2 2 0 0 0-.5 2.3A19 19 0 0 1 3.1 4a2 2 0 0 1 2.3-1.2" />
        </>
      }
    />
  ),
  ...
  bot: (p: IconProps) => (
    <IconBase
      {...p}
      d={<><rect x="4" y="7" width="16" height="12" rx="2" /><path d="M12 3v4M9 12h.01M15 12h.01M2 14h2M20 14h2" /></>}
    />
  ),
  ...
  copy: (p: IconProps) => (
    <IconBase
      {...p}
      d={<><rect x="9" y="9" width="12" height="12" rx="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" /></>}
    />
  ),
  edit: (p: IconProps) => (
    <IconBase
  ...
  eyeOff: (p: IconProps) => (
    <IconBase
      ...
      d={
        <>
          <path d="M17.9 17.9A10 10 0 0 1 12 20c-6 0-10-8-10-8a19 19 0 0 1 5.2-6" />
          <path d="M9.9 5.1A10 10 0 0 1 12 4c6 0 10 8 10 8a19 19 0 0 1-2.2 3.3M14.1 14.1a3 3 0 1 1-4.2-4.2" />
          <path d="M1 1l22 22" />
        </>
      }
    />
  ...
  sparkle: (p: IconProps) => (
    <IconBase
      {...p}
      d="M12 3l1.8 4.8L18.5 9.5l-4.8 1.8L12 16l-1.8-4.8L5.5 9.5l4.7-1.7L12 3zM19 15l.9 2.4 2.3.9-2.3.9-.9 2.3-.9-2.3-2.3-.9 2.3-.9.9-2.4z"
    />
  ),
