      ...
      {pulse && (
        <span
          style={{
            ...
            borderRadius: '50%',
            background: color,
            animation: 'lattice-pulse-ring 1.8s infinite',
          }}
        />
      )}
    </span>
        ...
        return (
          <button
            ...
            style={{
              ...
              fontSize: 12,
              border: 'none',
              background: active ? 'var(--lattice-surface)' : 'transparent',
              boxShadow: active ? 'var(--lattice-shadow-sm)' : 'none',
    ...
    >
      <div
        style={{
          ...
          inset: 0,
          background:
            'linear-gradient(90deg, transparent, var(--lattice-surface-3) 50%, transparent)',
          animation: 'lattice-shimmer-bar 1.6s infinite linear',
        }}
      />
    </div>
  )
